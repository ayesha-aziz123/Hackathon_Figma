      ...
      <div className="max-w-[84%] mx-auto">
        <div className="bg-white w-full md:flex-row flex-col py-4 flex justify-center items-center gap-8">
          <div className="md:w-[15%] hidden md:flex flex-col gap-4 items-center">
            <Image src="/subbag2.png" width={150} height={100} alt="image" />
            <Image src="/sub3.png" width={150} height={100} alt="image" />
            <Image src="/sub4.png" width={150} height={100} alt="image" />
          </div>
          <div className="md:w-[40%]">
            <Image src="/subbag1.png" width={400} height={100} alt="image" />
          </div>
