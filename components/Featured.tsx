...
function Featured() {
  return (
    <div className="max-w-[1920px] my-20 mx-5 sm:mx-10 lg:mx-32 xl:mx-20 ">
      {/* Header */}
        ...
        <div className="relative group w-full sm:w-[270px] flex justify-center items-center flex-col shadow-lg shadow-[#e1dfdf]">
          ...
          <div className="bg-opacity-0 group-hover:bg-[#2F1AC4] w-full text-white">
            <div className="py-4 px-3 text-center">
              ...
              />
              <p className="text-sm text-[#2F1AC4] group-hover:text-white sm:text-[14px]">Code - Y523201</p>
              <p className="set_lato text-[#2F1AC4] group-hover:text-white  py-2 text-base">$42.00</p>
            </div>
          </div>
        </div>
