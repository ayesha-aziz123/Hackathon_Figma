...
function Featured() {
  return (
    <div className="max-w-[1920px] mx-auto lg:mx-32 ">
      {/* Header */}
      ...
      <div className="flex justify-center mx-auto items-center ">
        <div className="grid items-center  sm:w-fit w-full  px-10 grid-cols-1 gap-16  lg:gap-x-36  sm:grid-cols-2  xl:grid-cols-4  mx-auto">
          {/* Product Card */}
