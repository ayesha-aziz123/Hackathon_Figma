...
const Shop = () => {
    const products = [
        ...
        { id: 2, title: 'Ultricies condimentum imperdiet', price: '$80.00', image: '/shop/g2.png' },
        { id: 3, title: 'Vitae suspendisse sed', price: '$120.00', image: '/shop/g3.png' },
        { id: 4, title: 'Sed at fermentum', price: '$60.00', image: '/shop/g4.png' },
        { id: 5, title: 'Fusce pellentesque at', price: '$300.00', image: '/shop/g5.png' },
        { id: 6, title: 'Vestibulum magna laoreet', price: '$90.00', image: '/shop/g6.png' },
        { id: 7, title: 'Sollicitudin amet orci', price: '$250.00', image: '/shop/g7.png' },
        { id: 8, title: 'Pellentesque condimentum ac', price: '$120.00', image: '/shop/g8.png' },
        { id: 9, title: 'Cras scelerisque velit', price: '$200.00', image: '/shop/g9.png' },
        { id: 10, title: 'Cras scelerisque velit', price: '$180.00', image: '/shop/g10.png' },
        { id: 11, title: 'Lectus vulputate faucibus', price: '$70.00', image: '/shop/g11.png' },
            ...
            <div className='max-w-[84%] mx-auto'>
                <div className='flex justify-between items-center gap-10 md:flex-row flex-col'>
                    <div className='flex flex-col gap-1'>
                        <h3 className='md:text-[22px] text-[#151875] font-bold'>Ecommerce Accessories & Fashion Items</h3>
                        <span className='text-sm text-[#8A8FB9] set_lato'>About 9,620 results (0.62 seconds)</span>
                    </div>
                ...
                <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-8 mt-12'>
                    {products.map((product) => (
                        <div className='col-span-1 flex items-center flex-col gap-2' key={product.id}>
                            ...
                            <span style={{textDecoration:"line-through"}} className='text-sm text-[#FB2E86] '>{product.price}</span>
                            </div>
                        </div>
                    ))}
                </div>
